...
- **Logic:** Instead of just calling `element.click()`, it should simulate the _cause_ of the interaction as the `EventRelay` would see it, or dispatch the resulting DOM event directly.
- **Mappings:**
...
```typescript
import { fireEvent, render, screen } from "@effect-native/opentui-dom-testing-library"
