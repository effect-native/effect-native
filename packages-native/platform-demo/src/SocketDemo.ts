...
export const errorHandling = Effect.gen(function*() {
  ...
  yield* logResult("Connection attempt", badConnection._tag === "Left" ? "Failed (as expected)" : "Unexpected success")
  ...
  yield* logResult("Send after close", sendResult._tag === "Left" ? "Failed (as expected)" : "Unexpected success")
  ...
  yield* logResult("Timeout", timeoutResult._tag === "Right" ? "Connected within timeout" : "Timed out")
