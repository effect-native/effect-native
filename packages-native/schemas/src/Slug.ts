 ...
 * @category Schema
 */
export const Slug: Schema.Codec<string, string> = Schema.String.pipe(
  Schema.decodeTo(Schema.String, {
    decode: SchemaGetter.transform(slugify),
    encode: SchemaGetter.transform((slug: string) => slug)
  })
)
 ...
 * @category Schema
 */
export const SlugBranded: Schema.Codec<SlugBrand, string> = Schema.String.pipe(
