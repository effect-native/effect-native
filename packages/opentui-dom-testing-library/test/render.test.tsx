...
describe("render()", () => {
  ...
  it("returns asFragment() that clones the container content", () => {
    ...
    // Modifying the clone does not affect the mounted container
    const originalHtml = container.innerHTML
    const clonedRoot = fragment.firstChild
    if (clonedRoot) {
      clonedRoot.textContent = "Changed"
    }

    expect(fragment.textContent).toContain("Changed")
